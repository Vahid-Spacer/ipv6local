...
ip -6 addr add fe80:470:1f10:e1f::1/64 dev 6to4tun_IR
ip link set 6to4tun_IR mtu 1480
ip link set 6to4tun_IR up
# confige tunnele GRE6 ya IPIPv6 IR
ip -6 tunnel add GRE6Tun_IR mode ip6gre remote fe80:470:1f10:e1f::2 local fe80:470:1f10:e1f::1
...
ip -6 addr add fe80:470:1f10:e1f::2/64 dev 6to4tun_KH
ip link set 6to4tun_KH mtu 1480
ip link set 6to4tun_KH up

ip -6 tunnel add GRE6Tun_KH mode ip6gre remote fe80:470:1f10:e1f::1 local fe80:470:1f10:e1f::2
...
if [[ "$choices" -eq 1 || "$choices" -eq 2 ]]; then
  ...
  echo "Local IPv6 Kharej: fe80:470:1f10:e1f::2"
  echo "Local Ipv6 Iran: fe80:470:1f10:e1f::1"
  fi
fi
